...
const summaryGenerator = {
        ...
        <div class="summary-section">
            ...
            <div class="collapsible-content">
                <div class="dim-section">
                    <div>
                        <div class="summary-item">
                            ...
                            <span class="summary-item-value">${totalDimensions.length} cm</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-item-key">Szélesség:</span>
                            <span class="summary-item-value">${totalDimensions.width} cm</span>
                        </div>
                    </div>
                    <div>
                        <div class="summary-item">
                            <span class="summary-item-key">Magasság:</span>
                            <span class="summary-item-value">${totalDimensions.height.withSides} cm</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-item-key">Alap magasság:</span>
                            <span class="summary-item-value">${totalDimensions.height.withoutSides.toFixed(1)} cm</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="summary-item">
                    ...
                    <span class="summary-item-value">${totalDimensions.totalVolume.toFixed(2)} cm³</span>
                </div>
                <div class="summary-item">
                    <span class="summary-item-key">Súly:</span>
                    <span class="summary-item-value">${weights.total.grams.toFixed(2)} g</span>
                </div>
            </div>
        </div>`;
    },
    ...
    createComponentCard: function(component) {
        ...
        <div class="component-card">
            ...
            ${component.dimensions ? this.createDimensionsItem(component.dimensions) : ''}
            
            <div class="summary-item">
                <span class="summary-item-key">Térfogat:</span>
                <span class="summary-item-value">${(component.volume || component.totalVolume).toFixed(2)} cm³</span>
            </div>
            
            <div class="summary-item">
                <span class="summary-item-key">Súly:</span>
                <span class="summary-item-value">${((component.weight || component.totalWeight) / 1000).toFixed(2)} kg</span>
            </div>`;
    ...
    createSubComponentItem: function(element) {
        ...
        <div class="sub-component">
            <div class="summary-item">
                ...
                <span class="summary-item-value">${element.count || 1} db</span>
            </div>
            
            ${element.dimensions ? this.createDimensionsItem(element.dimensions) : ''}
            
            ${element.volume ? `
            <div class="summary-item">
                <span class="summary-item-key">Térfogat:</span>
                <span class="summary-item-value">${element.volume.toFixed(2)} cm³</span>
            </div>
            ` : ''}
            ...
            <div class="summary-item">
                <span class="summary-item-key">Súly:</span>
                <span class="summary-item-value">${(element.weight / 1000).toFixed(2)} kg</span>
            </div>
            ` : ''}`;
    ...
    createMaterialsSection: function(summaryData) {
        ...
        weights.byMaterial.forEach(material => {
            ...
            <div class="summary-item">
                ...
                <span class="summary-item-value">${material.weightKg.toFixed(2)} kg</span>
            </div>`;
        });
